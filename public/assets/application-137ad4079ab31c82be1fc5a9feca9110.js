...
$(function() {
			...
			function init() {
				...
				loader.addEventListener( 'load', function ( event ) {
					...
					if(pattern == "/assets/obj/inner1.ply"){
                                          mesh.position.set( 0, 0, 0 );
                                        }
                                        else if(pattern == "/assets/obj/inner2.ply"){
                                          mesh.position.set( 0, 0, 0 );
                                        }
                                        else if(pattern == "/assets/obj/outer1.ply"){
